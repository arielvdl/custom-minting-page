...
const Home: NextPage = () => {
      ...
      { to: address as string, quantity },
      {
        ...
        onError: (err: any) => {
          if (err?.message.includes("User denied")) {
            ...
            setMessage(
              "Please verify that you are on the access list and try again."
            );
            // setMessage(err?.message);
          }
          openModal();
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
       <p className={styles.detail}>Tokenomics - 1000 Jerseys Pass: 50 Diamond Jersey - 50 Rarible Gold - more Jersey editions coming soon. <br></br> For the most optimal experience, use desktop. This free mint is exclusive to those who joined the Jersey airdrop list.</p> 
      </div>
